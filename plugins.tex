...
\newline
Enfin, la fonction \shellinline{readFrame} consiste simplement en deux étapes~:
\begin{enumerate}
  ...
  CUDA\footnote{Voir la section \cf{videostitch-sdk}.}, sont disponibles.
  La méthode appelle simplement celle qui correspond et copie le résultat dans le
  tampon \cppinline{uint32_t* frame}.
\end{enumerate}
