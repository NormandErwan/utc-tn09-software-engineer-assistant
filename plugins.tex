...
qui vont interragir entre eux~: ici les \textit{plugins} entrées/sorties avec Vahana VR. On entend
...
au besoin sans remplacer tout le logiciel. 
Un composant peut également être réutilisé par d'autres programmes.\\
...
du développeur appellant le script. Les \textit{plugins} ont été déplacés sur un autre dépôt
