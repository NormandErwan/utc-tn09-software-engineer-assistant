...
\begin{figure}
  ...
  \caption{Exemple de panorama assemblé et la détection des zones de chevauchement\cite{RochesterNY}}
  \label{RochesterNY}
\end{figure}

Concrètement, avec un appareil photograhique, cela consiste à prendre plusieurs vues
les unes à la suite des autres tout en faisant tourner l'appareil autour d'un axe
entre deux clichés. Les photos obtenues forment une série et doivent pouvoir chevaucher 
pour être ensuite assemblées une image panoramique. 
