...
Dans la vidéo 360, la projection la plus utilisée est la projection equirectangulaire.
Un exemple en est le planisphère terrestre, comme le montre les figures \ref{projection-cylindrique}
et \ref{planisphère}\cite{what-is-equirectangular}.
\begin{figure}
  \centering
  \begin{subfigure}{0.5\textwidth}
    \includegraphic[width=3cm]{images/Projection-cylindrique.jpg} 
    \caption{}
    \label{projection-cylindrique}
  \end{subfigure}%
  \begin{subfigure}{0.5\textwidth}
    \includegraphic[width=8cm]{images/Equirectangular-projection.jpg}
    \caption{}
    \label{projection-cylindrique}
  \end{subfigure}
\end{figure}
