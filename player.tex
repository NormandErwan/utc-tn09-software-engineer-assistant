...
pour Windows, qui a été précédemment définis avec l'id \mintinline{shell-session}{windows_apps}~:
\begin{minted}{python}
...
windows_apps.addStep(ShellCommand(command=["qmake"], workdir="VideoStitch-apps/src/vahana-vr", descriptionDone=["Generate Makefile for Vahana"])
